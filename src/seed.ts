...
async function main() {
  ...
  await prisma.kahonItem.deleteMany({});
  await prisma.kahon.deleteMany({});
  await prisma.inventory.deleteMany({});
  await prisma.inventorySheet.deleteMany({});
  await prisma.inventoryCell.deleteMany({});
  await prisma.inventoryRow.deleteMany({});
}
